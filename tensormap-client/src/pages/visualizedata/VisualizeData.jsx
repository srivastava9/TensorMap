...
class VisualizeData extends React.Component {
  constructor() {
    ...
    this.toggleFeatureCheckboxChange = this.toggleFeatureCheckboxChange.bind(
      this
    );
  ...
  componentWillMount() {
    ...
    let url = "http://127.0.0.1:5000/visualizeData/";
  ...
  saveConfig() {
    var obj = {
      trainPercentage: this.state.trainPercentage,
  ...
  deleteCol() {
    var obj = {
      columnData: this.state.columnCheckBoxes,
      fileName: this.state.fileName
    };
    var data = JSON.stringify(obj);
    console.log(data);
  ...
  toggleFeatureCheckboxChange(e) {
    ...
    if (featureColumn.checked == true) {
      ...
      for (var labeldata in currentLabels) {
        if (e.target.value == currentLabels[labeldata].title) {
          currentLabels.splice(
            currentLabels.indexOf(currentLabels[labeldata]),
            1
          );
      ...
      currentLabels.splice(
        tempFeatureData.indexOf(featureColumn),
        0,
        labelCheckBoxAlter
      );
      this.setState({ labels: currentLabels });
                  ...
                  <div>
                    ...
                    >
                      ...
                      <Tab eventKey="Percentage" title="Test Percentage">
                        <div className={classes.tabStyle}>
                          <label>
                            Percentage: {this.state.trainPercentage}
                          </label>
                          <div>
                            <input
                              type="range"

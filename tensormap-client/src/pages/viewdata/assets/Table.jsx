...
class EnhancedTable extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    const data_array = Object.values(nextProps.data);
    for (let i = 0; i < data_array.length; i++) {
      data__.push(
        createData(i, data_array[i].fileName, data_array[i].fileFormat)
      );
    }
    this.setState({
      data: data__
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="right">
                            <Link
                              to={{
                                pathname: `/visualize/${n.name}`,
                                state: { fileName: n.name, dtype: n.dtype }
                              }}
                            >
